...
def main(args):
    ...
    transform = Sentinel2Transform(spatial_encoder=args.t_spatial_encoder,
    ...
    for source, label, target, comment, is_train in zip(list_source, list_labels, list_targets, list_comment, list_is_train):
        ...
        reader = CS2Reader.S2Reader(input_dir=source,
                                    label_dir=label,
                                    output_dir=target,
                                    label_ids=label_ids,
...
if __name__=='__main__':
    ...
    parser.add_argument('--target-data-dir', type=str,
                        default='/work/ka1176/shared_data/2021-ai4food/dev_data/sentinel-2/default/')
